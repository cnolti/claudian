...
- **Tool-call grouping** — `src/features/chat/rendering/toolCallGrouping.ts` collapses runs of ≥2 consecutive tool/thinking blocks post-render (hooks: `StreamController.resetStreamingState`, `MessageRenderer` assistant rendering).
